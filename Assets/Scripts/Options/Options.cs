...
public class Options : MonoBehaviour
{
    ...
    [SerializeField] string _policyString = "https://www.termsfeed.com/live/92b913b9-fd44-47ee-a078-057f38fbf106";
    [SerializeField] string _termsString = "https://www.termsfeed.com/live/51599f70-d30c-46e0-a4c5-b9f0d7354025";
    ...
    void ToggleSound()
    {
        if (textSound.text == "Sound OFF")
        {
            ...
            SoundManager.InstanceSound.sountFirstVisit.volume = 1f;
            SoundManager.InstanceSound.sountWictory.volume = 1f;
            SoundManager.InstanceSound.sountFirstPerson.volume = 1f;
        ...
        else
        {
            ...
            SoundManager.InstanceSound.sountFirstVisit.volume = 0f;
            SoundManager.InstanceSound.sountWictory.volume = 0f;
            SoundManager.InstanceSound.sountFirstPerson.volume = 0f;
        }
    }
